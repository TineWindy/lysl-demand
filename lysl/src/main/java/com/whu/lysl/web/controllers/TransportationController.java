...
/**
 * @Author Caspar
 * @CreateTime 2020/2/26 14:47
 * @Description:
 */
@Slf4j
@RestController
@RequestMapping("transportation")
public class TransportationController extends LYSLBaseController {
    @Resource
     ...
     * @return json str
     */
    @GetMapping("getTransportationListApproved")
    public String getTransportationListApproved(HttpServletRequest request) {
